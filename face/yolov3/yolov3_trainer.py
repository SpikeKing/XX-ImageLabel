...
from face.yolov3.core.model import preprocess_true_boxes, yolo_body, yolo_loss
from face.yolov3.core.utils import get_random_data
from face.yolov3.module_dir import MODEL_DATA
...
def _main():
    ...
    annotation_path = 'model_data/WIDER_train.txt'  # 数据
    classes_path = 'configs/wider_classes.txt'  # 类别

    log_dir = 'logs/004/'  # 日志文件夹

    # pretrained_path = 'model_data/yolo_weights.h5'  # 预训练模型
    pretrained_path = os.path.join(MODEL_DATA, 'ep074-loss26.535-val_loss27.370.h5')  # 预训练模型
